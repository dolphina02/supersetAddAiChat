...
class SupersetAppInitializer:  # pylint: disable=too-many-public-methods
    ...
    def init_views(self) -> None:
        ...
        # MCP Client API for AI Assistant
        try:
            from superset.views.mcp_client_api import McpClientApi
            appbuilder.add_api(McpClientApi)
            logger.info("MCP Client API registered successfully")
        except ImportError as e:
            logger.warning(f"Failed to register MCP Client API: {e}")
